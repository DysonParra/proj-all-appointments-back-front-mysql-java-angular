...
/**
 * TODO: Description of {@code ServiceBookedViewModel}.
 *
 * @author Dyson Parra
...
export class ServiceBookedViewModel extends GenericViewModel<number> {
     ...
     *
     */
    public newEntity(): ServiceBookedViewModel {
        return new ServiceBookedViewModel();
    }
