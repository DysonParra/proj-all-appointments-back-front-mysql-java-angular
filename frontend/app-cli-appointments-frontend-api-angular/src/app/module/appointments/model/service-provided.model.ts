/*
 * @fileoverview    {ServiceProvidedViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code ServiceProvidedViewModel}.
 *
 * @author Dyson Parra
...
export class ServiceProvidedViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intId: number;
    public intAppointmentI: number;
    public intServiceId: number;
     ...
     *
     */
    public newEntity(): ServiceProvidedViewModel {
