...
/**
 * TODO: Description of {@code ServiceViewModel}.
 *
 * @author Dyson Parra
...
export class ServiceViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intId: number;
    public strServiceName: string;
     ...
     *
     */
    public newEntity(): ServiceViewModel {
