...
/**
 * TODO: Description of {@code ClientViewModel}.
 *
 * @author Dyson Parra
...
export class ClientViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intId: number;
    public strClientName: string;
    public strContactMobile: string;
    public strContactMail: string;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): ClientViewModel {
