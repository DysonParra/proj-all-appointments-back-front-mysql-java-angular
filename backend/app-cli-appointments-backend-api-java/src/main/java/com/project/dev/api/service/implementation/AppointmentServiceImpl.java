/*
 * @overview        {AppointmentServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code AppointmentServiceImpl}.
 *
 * @author Dyson Parra
...
public class AppointmentServiceImpl implements GenericService<AppointmentDTO> {
    ...
    public Page<AppointmentDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Appointment con paginación");
    ...
    public AppointmentDTO saveUpdate(AppointmentDTO entityDTO) throws Exception {
        ...
        AppointmentDTO dto = entityMapping.getDto(entity);
        return dto;
    }
