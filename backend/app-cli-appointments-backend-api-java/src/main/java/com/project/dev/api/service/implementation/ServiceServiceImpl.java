...
/**
 * TODO: Description of {@code ServiceServiceImpl}.
 *
 * @author Dyson Parra
...
public class ServiceServiceImpl implements GenericService<ServiceDTO> {
    ...
    public Page<ServiceDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Service con paginación");
    ...
    public ServiceDTO saveUpdate(ServiceDTO entityDTO) throws Exception {
        ...
        ServiceDTO dto = entityMapping.getDto(entity);
        return dto;
    }
