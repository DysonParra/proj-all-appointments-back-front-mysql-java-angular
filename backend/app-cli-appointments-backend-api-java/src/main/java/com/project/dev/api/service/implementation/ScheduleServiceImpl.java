...
public class ScheduleServiceImpl implements GenericService<ScheduleDTO> {
    ...
    private final ScheduleMapping entityMapping = Mappers.getMapper(ScheduleMapping.class);
     ...
     */
    public ScheduleServiceImpl(ScheduleRepository entityRepository) {
    ...
    public Page<ScheduleDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Schedule con paginación");
     ...
     */
    @Override
    public ScheduleDTO saveUpdate(ScheduleDTO entityDTO) throws Exception {
        log.debug("Solicitud para guardar la entidad tipo Schedule: {}", entityDTO);

        //TODO: agregar validación específica del servicio.
        Schedule entity = entityMapping.getEntity(entityDTO);
        entity = entityRepository.save(entity);

        ScheduleDTO dto = entityMapping.getDto(entity);
        return dto;
    }
     ...
     */
    @Override
    public ScheduleDTO getEntity(String id) throws Exception {
    ...
    public void deleteEntity(String id) throws Exception {
        log.debug("Solicitud para eliminar la entidad tipo Schedule: {}", id);
