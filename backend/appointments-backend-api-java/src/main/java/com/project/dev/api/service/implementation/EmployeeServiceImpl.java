/*
 * @fileoverview    {EmployeeServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code EmployeeServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDTO saveUpdate(EmployeeDTO entityDTO) throws Exception {
        ...
        EmployeeDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
