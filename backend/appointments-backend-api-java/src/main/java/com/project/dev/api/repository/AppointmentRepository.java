...
/**
 * TODO: Definición de {@code AppointmentRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
     ...
     */
    public List<Appointment> findByIntId(Long id);
    ...
    @Query("SELECT m FROM Appointment m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public List<Appointment> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Appointment m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Appointment> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
