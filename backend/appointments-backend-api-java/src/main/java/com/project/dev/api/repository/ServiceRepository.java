/*
 * @fileoverview    {ServiceRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code ServiceRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface ServiceRepository extends JpaRepository<Service, Long> {
     ...
     */
    public List<Service> findByIntId(Long id);
    ...
    @Query("SELECT m FROM Service m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public List<Service> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Service m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Service> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
