/*
 * @fileoverview    {EmployeeRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code EmployeeRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
     ...
     */
    public List<Employee> findByIntId(Long id);
    ...
    @Query("SELECT m FROM Employee m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public List<Employee> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Employee m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Employee> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
