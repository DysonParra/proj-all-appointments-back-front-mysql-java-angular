...
import com.project.dev.api.web.rest.assembler.ScheduleRestAssembler;
...
/**
 * TODO: Definición de {@code ScheduleRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class ScheduleRest {
    ...
    private final ScheduleService entityService;
    private final ScheduleRestAssembler entityRestAssembler;
     ...
     */
    public ScheduleRest(ScheduleService entityService,
            ScheduleRestAssembler entityRestAssembler) {
    ...
    public CollectionModel<EntityModel<ScheduleDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<ScheduleDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(ScheduleRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<ScheduleDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/Schedule/{query}/pages")
    public ResponseEntity<List<ScheduleDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/Schedule/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
